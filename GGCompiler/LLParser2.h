...
#ifndef LLVM_ASMPARSER_LLPARSER2_H
#define LLVM_ASMPARSER_LLPARSER2_H
...
namespace llvm {
  ...
  public:
    LLParser2(MemoryBuffer *F, SourceMgr &SM, SMDiagnostic &Err, Module *m) :
  ...
  private:
    ...
    class PerFunctionState {
      ...
      int FunctionNumber;
    public:
      PerFunctionState(LLParser2 &p, Function &f, int FunctionNumber);
      ~PerFunctionState();
